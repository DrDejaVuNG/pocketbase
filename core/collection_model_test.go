...
func TestCollectionSaveViewWrapping(t *testing.T) {
	...
	scenarios := []struct {
	...
	}{
		{
			...
			*/
			// PostgreSQL:
			`CREATE VIEW "test_wrapping" AS  SELECT id, bool FROM ( SELECT demo1.id, demo1.bool FROM demo1) unnamed_subquery;`,
		},
		{
			...
			*/
			// PostgreSQL:
			`CREATE VIEW "test_wrapping" AS  SELECT id, bool FROM ( SELECT demo1.text AS id, demo1.bool FROM demo1 LIMIT 0) unnamed_subquery;`,
		},
		{
			...
			*/
			// PostgreSQL:
			`CREATE VIEW "test_wrapping" AS  SELECT id, bool FROM ( SELECT demo1.rel_one AS id, demo1.bool FROM demo1 LIMIT 0) unnamed_subquery;`,
		},
		{
			...
			*/
			// PostgreSQL:
			`CREATE VIEW "test_wrapping" AS  SELECT id, bool FROM ( SELECT demo1.select_many AS id, demo1.bool FROM demo1 LIMIT 0) unnamed_subquery;`,
		},
		{
			...
			*/
			// PostgreSQL:
			`CREATE VIEW "test_wrapping" AS  SELECT id, bool FROM ( SELECT demo1.email AS id, demo1.bool FROM demo1 LIMIT 0) unnamed_subquery;`,
		},
		{
			...
			*/
			// PostgreSQL:
			`CREATE VIEW "test_wrapping" AS  SELECT id, bool FROM ( SELECT demo1.datetime AS id, demo1.bool FROM demo1 LIMIT 0) unnamed_subquery;`,
		},
		{
			...
			*/
			// PostgreSQL:
			`CREATE VIEW "test_wrapping" AS  SELECT id, bool FROM ( SELECT demo1.url AS id, demo1.bool FROM demo1 LIMIT 0) unnamed_subquery;`,
		},
		{
			"wrapping - bool field",
			...
			*/
			// PostgreSQL:
			`CREATE VIEW "test_wrapping" AS  SELECT id, txt, url FROM ( SELECT (unnamed_subquery_1.id)::text AS id, unnamed_subquery_1.txt, unnamed_subquery_1.url FROM ( SELECT demo1.bool AS id, demo1.text AS txt, demo1.url FROM demo1 LIMIT 0) unnamed_subquery_1) unnamed_subquery;`,
		},
		{
			...
			*/
			// PostgreSQL:
			`CREATE VIEW "test_wrapping" AS  SELECT txt, url, id FROM ( SELECT unnamed_subquery_1.txt, unnamed_subquery_1.url, (unnamed_subquery_1.id)::text AS id FROM ( SELECT demo1.text AS txt, demo1.url, demo1.bool AS id FROM demo1 LIMIT 0) unnamed_subquery_1) unnamed_subquery;`,
		},
		{
			"wrapping - json field",
			...
			*/
			// PostgreSQL:
			`CREATE VIEW "test_wrapping" AS  SELECT id, text, url FROM ( SELECT (unnamed_subquery_1.id)::text AS id, unnamed_subquery_1.text, unnamed_subquery_1.url FROM ( SELECT demo1."json" AS id, demo1.text, demo1.url FROM demo1 LIMIT 0) unnamed_subquery_1) unnamed_subquery;`,
		},
		{
			"wrapping - numeric id",
			"select 1 as id",
